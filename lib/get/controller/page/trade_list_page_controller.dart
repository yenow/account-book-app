...
class TabBarListController extends GetxController {
  static TabBarListController get to => Get.find();
  // final tabbarController = TabController(length: length, vsync: vsync)
}
