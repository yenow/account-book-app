...
import 'package:account_book/data/client/account_client.dart';
...
import 'package:account_book/data/dto/account/accounts_by_type_dto.dart';
...
void main() async {
  ...
  String accessToken =
      'eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJwaGFudG9tX3lzeUBuYXZlci5jb20iLCJyb2xlIjoiUk9MRV9VU0VSIiwiaXNzIjoieXN5IiwiaWF0IjoxNjkxNDM1NzgzLCJleHAiOjE2OTIwNDA1ODN9.u65wKOz2JYWWGTY0H0XMFZyzVlGi_j1hwv4tMZXrKR4';
  ...
  group('trade_api_test.dart', () {
    test('trade_api_test.dart', () async {
      final accountClient = AccountClient(testDio);
      SingleResponse<AccountsByTypeDto> mapResponse = await accountClient.findAccountsByAccountType();
      log.i(mapResponse);
    });
  });
}
